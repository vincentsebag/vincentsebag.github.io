...
CheckForm.prototype = {
	...
	*/
	...
	controlepseudo: function (chp, typ, reg, event, mes, par, custom_reg, liens, operateur_liens, tab_comp, type_comp,custom_cond) {
	this.initialise(arguments);
			var att = this.c.length-1;
			alert(event);
			
			this.addEventListener(this.$(chp),event,this.validatePseudo(this.$(chp)),false);
			alert('i am coming3');
	...
	validatePseudo: function(champ) {
		if (arguments.length !== 0)
		{
			var fichier='verifpseudo.php?pseudo='+escape(champ);
